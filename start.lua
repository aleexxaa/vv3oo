...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or "رايوت"
SudosS = {620800281}
Sudos = {sudoid,620800281}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
type = 'inline',
data = {
{{text = '❲ Source  RAYOT ❳',url="t.me/FF6FF"}},
}
}
...
{{text ="❲ 6 ❳",data="Amr_"..data.sender_user_id.."_6"}},
{{text = '⋄︙الاوامر الرئيسيه .',data="Amr_"..data.sender_user_id.."_7"}},
}
}
if infomsg[2] == '1' then
reply_markup = reply_markup
t = "*•🔒 | أوامر الحمايه . \n•⚠️ | تستطيع القفل ⇜ بالكتم / بالطرد /بالتقييد .\n━─━─────━─────━\n- فتح / قفل ⇜ الفشار\n- فتح / قفل ⇜ الفارسيه\n- فتح / قفل ⇜ الانكليزيه\n- فتح / قفل ⇜ الدردشه\n- فتح / قفل ⇜ الدخول\n- فتح / قفل ⇜ الاضافه\n- فتح / قفل ⇜ القناه\n- فتح / قفل ⇜ الاشعارات\n- فتح / قفل ⇜ التثبيت \n- فتح / قفل ⇜ التعديل \n- فتح / قفل ⇜ تعديل الميديا\n- فتح / قفل ⇜ الكل \n- فتح / قفل ⇜ التكرار\n- فتح / قفل ⇜ الروابط  \n- فتح / قفل ⇜ المعرفات \n- فتح / قفل ⇜ تاك \n- فتح / قفل ⇜ الشارحه \n- فتح / قفل ⇜ الصور \n- فتح / قفل ⇜ الفيديو \n- فتح / قفل ⇜ الاغاني\n- فتح / قفل ⇜ الصوت \n- فتح / قفل ⇜ الكيبورد \n- فتح / قفل ⇜ الملصقات \n- فتح / قفل ⇜ البوتات\n- فتح / قفل ⇜ التوجيه \n- فتح / قفل ⇜ الملفات\n- فتح / قفل ⇜ السيلفي \n- فتح / قفل ⇜ الماركداون \n- فتح / قفل ⇜ الجهات \n- فتح / قفل ⇜ الكلايش \n- فتح / قفل ⇜ الانلاين\n━─━─────━─────━*"
elseif infomsg[2] == '2' then
reply_markup = reply_markup
...
elseif infomsg[2] == '5' then
reply_markup = reply_markup
t = "*•👾| أوامر الألعاب .\n━─━─────━─────━\n- أرسل ❲ خمن ❳ لبدء اللعب\n- أرسل ❲ كت ❳ لبدء اللعب\n- أرسل ❲ ترتيب ❳ لبدء اللعب\n- أرسل ❲ سمايلات ❳ لبدء اللعب \n- أرسل ❲ حزوره ❳ لبدء اللعب \n- أرسل ❲ معاني ❳ لبدء اللعب \n- أرسل ❲ العكس ❳ لبدء اللعب  \n- أرسل ❲ امثله ❳ لبدء اللعب\n- أرسل ❲ المختلف ❳ لبدء اللعب \n- أرسل ❲ اسالني ❳ لبدء اللعب\n- نقاطي ⇜ لعرض نقاطك\n━─━─────━─────━*"
...
t = "*•🤖 | قائمة أوامر البوت .\n━─━─────━─────━\n- أرسل ❲ م1 ❳ لعرض أوامر الحماية\n- أرسل ❲ م2 ❳ لعرض أوامر التفعيلات\n- أرسل ❲ م3 ❳ لعرض ترتيب الأوامر\n- أرسل ❲ م4 ❳ لعرض أوامر الترفيه\n- أرسل ❲ م5 ❳ لعرض أوامر الألعاب\n- أرسل ❲ م6 ❳ لعرض أوامر البنك\n━─━─────━─────━ *"
end
bot.editMessageText(chat_id,msg_id,t, 'md', true, false, reply_markup)
end
----------------------------------------------------------------------------------------------------
...
{{text = '⋄ قناه التحديثات .',url="t.me/FF6FF"}},
{{text = '⋄ رجوع .',data="Can"}},
}
}
...
{{text = '⋄ تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "رايوت"),data="delnamebot"}},
...
os.execute('curl -s https://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@raw.githubusercontent.com/botyoutobe/uu/main/start.lua -o start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
...
{{text ="❲ 6 ❳",data="Amr_"..msg.sender_id.user_id.."_6"}},
{{text = '❲ Source  RAYOT ❳',url="t.me/FF6FF"}},
}
}
bot.sendText(msg.chat_id,msg.id,"*•🤖 | قائمة أوامر البوت .\n━─━─────━─────━\n- أرسل ❲ م1 ❳ لعرض أوامر الحماية\n- أرسل ❲ م2 ❳ لعرض أوامر التفعيلات\n- أرسل ❲ م3 ❳ لعرض ترتيب الأوامر\n- أرسل ❲ م4 ❳ لعرض أوامر الترفيه\n- أرسل ❲ م5 ❳ لعرض أوامر الألعاب\n- أرسل ❲ م6 ❳ لعرض أوامر البنك\n━─━─────━─────━*","md", true, false, false, false, reply_markup)
end
...
bot.sendText(msg.chat_id,msg.id,"*•🔒 | أوامر الحمايه . \n•⚠️ | تستطيع القفل ⇜ بالكتم / بالطرد /بالتقييد .\n━─━─────━─────━\n- فتح / قفل ⇜ الفشار\n- فتح / قفل ⇜ الفارسيه\n- فتح / قفل ⇜ الانكليزيه\n- فتح / قفل ⇜ الدردشه\n- فتح / قفل ⇜ الدخول\n- فتح / قفل ⇜ الاضافه\n- فتح / قفل ⇜ القناه\n- فتح / قفل ⇜ الاشعارات\n- فتح / قفل ⇜ التثبيت \n- فتح / قفل ⇜ التعديل \n- فتح / قفل ⇜ تعديل الميديا\n- فتح / قفل ⇜ الكل \n- فتح / قفل ⇜ التكرار\n- فتح / قفل ⇜ الروابط  \n- فتح / قفل ⇜ المعرفات \n- فتح / قفل ⇜ تاك \n- فتح / قفل ⇜ الشارحه \n- فتح / قفل ⇜ الصور \n- فتح / قفل ⇜ الفيديو \n- فتح / قفل ⇜ الاغاني\n- فتح / قفل ⇜ الصوت \n- فتح / قفل ⇜ الكيبورد \n- فتح / قفل ⇜ الملصقات \n- فتح / قفل ⇜ البوتات\n- فتح / قفل ⇜ التوجيه \n- فتح / قفل ⇜ الملفات\n- فتح / قفل ⇜ السيلفي \n- فتح / قفل ⇜ الماركداون \n- فتح / قفل ⇜ الجهات \n- فتح / قفل ⇜ الكلايش \n- فتح / قفل ⇜ الانلاين\n━─━─────━─────━*","md",true)
elseif text == "م2" or text == "م٢" then    
bot.sendText(msg.chat_id,msg.id,"*•⚙️ | أوامر التفعيلات .\n━─━─────━─────━\n- تفعيل / تعطيل ⇜ الرفع \n- تفعيل / تعطيل ⇜ الحظر \n- تفعيل / تعطيل ⇜ الايدي\n- تفعيل / تعطيل ⇜ صورتي\n- تفعيل / تعطيل ⇜ منو ضافني\n- تفعيل / تعطيل ⇜ التحقق\n- تفعيل / تعطيل ⇜ الالعاب\n- تفعيل / تعطيل ⇜ اطردني\n- تفعيل / تعطيل ⇜ الرابط \n- تفعيل / تعطيل ⇜ الترحيب\n- تفعيل / تعطيل ⇜ غنيلي\n- تفعيل / تعطيل ⇜ ردود البوت \n- تفعيل / تعطيل ⇜ الايدي بالصوره\n- تفعيل / تعطيل ⇜ المسح التلقائي\n- تفعيل / تعطيل ⇜ التفليش\n━─━─────━─────━*","md",true)
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/FF6FF&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعه" then
bot.sendText(msg.chat_id,msg.id,"*⋄︙الساعه الان : ( "..os.date("%I:%M%p").." ) .*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"حجي اسمي "..(redis:get(bot_id..":namebot") or "رايوت"),"يابه اسمي "..(redis:get(bot_id..":namebot") or "رايوت"),"اني لقميل "..(redis:get(bot_id..":namebot") or "رايوت"),(redis:get(bot_id..":namebot") or "رايوت").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end 
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "رايوت") then
...
local UserId_Info = bot.searchPublicChat("FSFFF")
if UserId_Info.id then
...
reply_to_message_id=msg.id,
reply_markup=markup(nil,{{{text = '❲ Source  RAYOT ❳',url="t.me/FF6FF"}}})
})
end
end
if not redis:get(bot_id..":"..msg.chat_id..":settings:singforme") then
...
return send("sendphoto",{
chat_id=msg.chat_id,
photo="https://t.me/FF6FF",
caption=('*Welcome To Source  RAYOT 𝖳𝖾𝖺𝗆 .\n\n*[❲  RAYOT Channal ❳](http://t.me/FF6FF)*\n\n*[❲   𝗂𝗇𝖥𝗈 𝖲𝗈𝗎𝗋𝖼𝖾 ❳](http://t.me/FF6FF)*\n\n*[❲  RAYOT 𝖣𝖾𝗋𝖾𝗅𝗈𝗉𝖾𝗋 ❳](http://t.me/FSFFF)*\n\n*[❲  𝖡𝗈𝗍 RAYOT ❳](http://t.me/RIOKNBOT)'),
reply_to_message_id=msg.id,
parse_mode="markdown",
reply_markup=markup(nil,{{{text = '❲ Source  RAYOT ❳',url="t.me/FF6FF"}}})
})
